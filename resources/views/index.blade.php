  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        ...
        <img src="{{$Dino_1['Imagen']}}" alt="" class="img-responsive" style="width: 100px; height: 100px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
            <img src="{{$Dino_3['Imagen']}}" class="img-responsive" style="width: 100px; height: 100px">
            <p><a href="{{route('dinosaurios', $Dino_3['ID'])}}" class="btn btn-primary btn-lg">{{$Dino_3['Nombre']}}</a></p>
            </div>
        </div>

        <img src="{{$Dino_4['Imagen']}}" class="img-responsive" style="width: 100px; height: 100px">
        <p><a href="{{route('dinosaurios', $Dino_4['ID'])}}" class="btn btn-primary btn-lg">{{$Dino_4['Nombre']}}</a></p>
